...
var Scripts;
(function (Scripts) {
    function displayNameForScriptId(scriptId) {
        return `${ChromeUtils.EVAL_NAME_PREFIX}${scriptId}`;
    }
    Scripts.displayNameForScriptId = displayNameForScriptId;
    /**
    ...
    Scripts.displayPathToRealPath = displayPathToRealPath;
