...
class ChromeDebugAdapter {
    constructor({ chromeConnection, lineColTransformer, sourceMapTransformer, pathTransformer, targetFilter }, session) {
        ...
        this._scriptContainer = new scripts_1.ScriptContainer();
        this._transformers = {
        ...
        this._breakpoints = new breakpoints_1.Breakpoints(this, this._chromeConnection);
    ...
    */
    ...
    realPathToDisplayPath(realPath) { return scripts_1.Scripts.realPathToDisplayPath(realPath); }
    displayPathToRealPath(displayPath) { return scripts_1.Scripts.displayPathToRealPath(displayPath); }
    /* __GDPR__
